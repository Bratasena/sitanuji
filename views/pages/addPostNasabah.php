...
<div class="container">
  <div class="col-md-6">
		...
		<input type="hidden" name="controller" value="postNasabah">
		<input type="hidden" name="action" value="addDataPost">
          ...
          <a href="index.php?controller=postNasabah&action=postNasabah"><button type="button" class="btn btn-success">Back </button>
        </div>
      </div>
        </div>
      </div>
