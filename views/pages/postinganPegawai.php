...
<html>
  ...
  <body>
    <div class="container">
  <a href="?controller=postPegawai&action=addPost"><button type="button" class="btn btn-info">Tambah Postingan</button></a>
  <br><br>
    </div>
    <div class="container-fluid text-center">
      <div class="container-fluid text-center">
        <div class="row content">
          ...
          <a href="?controller=komentarAll&action=komentarAll&id=<?=$post->id?>"> <button type="button" class="btn btn-success">
            <?php
