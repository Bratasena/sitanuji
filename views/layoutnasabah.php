...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="index.php?controller=postNasabah&action=postNasabah">Kelola Postingan</a></li>
      <li><a href="index.php?controller=home&action=homeNasabah">Lihat Saldo</a></li>
