...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">SITANUJI-ADMIN</a>
    </div>
    <ul class="nav navbar-nav">
        <li><a href="index.php?controller=home&action=home">Pegawai</a></li>
      <li><a href="index.php?controller=home&action=postAdmin">Kelola Postingan</a></li>
