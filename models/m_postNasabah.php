...
class PostNasabah
{
  ...
  public static function posting(){
    ...
    foreach ($req->fetchAll() as $post) {
      $list[] = new PostNasabah($post['idPosting'],$post['gambar'],$post['idUser'],$post['status'],$post['deskripsi'],$post['nama'],$post['username'],$post['jabatan'],"");
    }
    return $list;
  }
  ...
  public static function jumlah(){
    ...
    foreach ($req->fetchAll() as $post) {
      $list[] = new PostNasabah("","","","","","","","",$post['jumlah']);
    }
    return $list;
  }
